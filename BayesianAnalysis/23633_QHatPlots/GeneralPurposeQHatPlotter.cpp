...
int main(int argc, char *argv[])
{
   ...
   if(DoInset == true)
   {
      ...
      Latex.SetTextAlign(22);
      Latex.SetTextSize(0.04 / (InsetTop - InsetBottom));
      Latex.DrawLatex(0.500, 0.675, Label.c_str());
